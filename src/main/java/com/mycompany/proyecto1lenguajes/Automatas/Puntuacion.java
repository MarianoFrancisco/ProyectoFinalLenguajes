...
public class Puntuacion {
    ...
    public int conseguirSiguiente(int estadoPasable,int caracter){
        resultado=4;
        //verificamos caracter menor igual a 3
    ...
    public void inicializacion(String linea,JTextArea movimiento){
        ...
        puntuacionTotal=puntuacionTotal+Character.toString(caract[iterador]);
        
        iterador++;
        }
        movimiento.setText(movimiento.getText()+"------------ Al usar "+puntuacionTotal+" ----------\n");
        ...
        movilizar.setCadenaUsada(puntuacionTotal.replaceAll(" ", ""));
        if(enviarReporte==1){
            try {
            ...
            try {
                ...
                if (movilizar.getCondicionalRecuperacion()==1) {
                    ...
                    //modificamos texto
                    recuperacionErrores.setText(recuperacionErrores.getText()+cadenaUsada+" <--- Error en "+movilizar.getCadenaError()+" pero detecta token Puntuacion = "+movilizar.getCadenaUsada()+" \n");
